/* Generated by Cython 0.14.1 on Fri Sep  9 20:59:35 2011 */
...
/* "imfeat/_autocorrelogram/autocorrelogram.pyx":12
...
static int __pyx_module_is_main__imfeat_autocorrelogram = 0;
...
static char __pyx_k_3[] = "Invalid unique_colors value!";
...
/* "imfeat/_autocorrelogram/autocorrelogram.pyx":17
...
static int __pyx_pf_23_imfeat_autocorrelogram_15Autocorrelogram___init__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  if (unlikely(__pyx_kwds)) {
    ...
    values[0] = ((PyObject *)__pyx_k_tuple_1);
    ...
    __pyx_v_distance_set = ((PyObject *)__pyx_k_tuple_2);
  ...
  /* "imfeat/_autocorrelogram/autocorrelogram.pyx":18
 * 
 *     def __init__(self, distance_set=(1,3,5,7), unique_colors=64):
 *         super(Autocorrelogram, self).__init__()             # <<<<<<<<<<<<<<
 *         assert unique_colors == 16 or unique_colors == 64
 ...
 */
  ...
  __pyx_t_2 = PyObject_Call(__pyx_builtin_super, ((PyObject *)__pyx_t_1), NULL); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 18; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  /* "imfeat/_autocorrelogram/autocorrelogram.pyx":19
 *     def __init__(self, distance_set=(1,3,5,7), unique_colors=64):
 *         super(Autocorrelogram, self).__init__()
 *         assert unique_colors == 16 or unique_colors == 64             # <<<<<<<<<<<<<<
 *         self.MODES = {'type': 'numpy', 'dtype': 'uint8', 'mode': 'rgb'}
 ...
 */
  ...
  /* "imfeat/_autocorrelogram/autocorrelogram.pyx":20
 *         super(Autocorrelogram, self).__init__()
 *         assert unique_colors == 16 or unique_colors == 64
 *         self.MODES = {'type': 'numpy', 'dtype': 'uint8', 'mode': 'rgb'}             # <<<<<<<<<<<<<<
 *         self.distance_set = np.ascontiguousarray(distance_set, dtype=np.int32)
 ...
 */
  ...
  if (PyDict_SetItem(__pyx_t_2, ((PyObject *)__pyx_n_s__type), ((PyObject *)__pyx_n_s__numpy)) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 20; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (PyDict_SetItem(__pyx_t_2, ((PyObject *)__pyx_n_s__dtype), ((PyObject *)__pyx_n_s__uint8)) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 20; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (PyDict_SetItem(__pyx_t_2, ((PyObject *)__pyx_n_s__mode), ((PyObject *)__pyx_n_s__rgb)) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 20; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  ((struct __pyx_obj_23_imfeat_autocorrelogram_Autocorrelogram *)__pyx_v_self)->MODES = ((PyObject *)__pyx_t_2);
  __pyx_t_2 = 0;

  /* "imfeat/_autocorrelogram/autocorrelogram.pyx":21
 *         assert unique_colors == 16 or unique_colors == 64
 *         self.MODES = {'type': 'numpy', 'dtype': 'uint8', 'mode': 'rgb'}
 *         self.distance_set = np.ascontiguousarray(distance_set, dtype=np.int32)             # <<<<<<<<<<<<<<
 *         self.unique_colors = unique_colors
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_1 = PyObject_GetAttr(__pyx_t_2, __pyx_n_s__ascontiguousarray); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 21; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  ...
  PyTuple_SET_ITEM(__pyx_t_2, 0, __pyx_v_distance_set);
  ...
  __pyx_t_8 = PyEval_CallObjectWithKeywords(__pyx_t_1, ((PyObject *)__pyx_t_2), ((PyObject *)__pyx_t_6)); if (unlikely(!__pyx_t_8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 21; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_8);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  ...
  /* "imfeat/_autocorrelogram/autocorrelogram.pyx":22
 *         self.MODES = {'type': 'numpy', 'dtype': 'uint8', 'mode': 'rgb'}
 *         self.distance_set = np.ascontiguousarray(distance_set, dtype=np.int32)
 *         self.unique_colors = unique_colors             # <<<<<<<<<<<<<<
 * 
...
/* "imfeat/_autocorrelogram/autocorrelogram.pyx":24
 *         self.unique_colors = unique_colors
 * 
 *     cpdef make_features(self, image_in):             # <<<<<<<<<<<<<<
...
static PyObject *__pyx_pf_23_imfeat_autocorrelogram_15Autocorrelogram_1make_features(PyObject *__pyx_v_self, PyObject *__pyx_v_image_in); /*proto*/
static  PyObject *__pyx_f_23_imfeat_autocorrelogram_15Autocorrelogram_make_features(struct __pyx_obj_23_imfeat_autocorrelogram_Autocorrelogram *__pyx_v_self, PyObject *__pyx_v_image_in, int __pyx_skip_dispatch) {
  ...
  /* Check if overriden in Python */
    ...
    __Pyx_GOTREF(__pyx_t_1);
    if (!PyCFunction_Check(__pyx_t_1) || (PyCFunction_GET_FUNCTION(__pyx_t_1) != (void *)&__pyx_pf_23_imfeat_autocorrelogram_15Autocorrelogram_1make_features)) {
  ...
  /* "imfeat/_autocorrelogram/autocorrelogram.pyx":25
 * 
 *     cpdef make_features(self, image_in):
 *         cdef np.ndarray image = image_in             # <<<<<<<<<<<<<<
 *         cdef int out_ac_size = self.unique_colors * len(self.distance_set)
 ...
 */
  if (!(likely(((__pyx_v_image_in) == Py_None) || likely(__Pyx_TypeTest(__pyx_v_image_in, __pyx_ptype_5numpy_ndarray))))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 25; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_INCREF(__pyx_v_image_in);
  __pyx_v_image = ((PyArrayObject *)__pyx_v_image_in);

  /* "imfeat/_autocorrelogram/autocorrelogram.pyx":26
 *     cpdef make_features(self, image_in):
 *         cdef np.ndarray image = image_in
 *         cdef int out_ac_size = self.unique_colors * len(self.distance_set)             # <<<<<<<<<<<<<<
 *         cdef np.ndarray out = np.zeros(out_ac_size)
 ...
 */
  __pyx_t_1 = ((PyObject *)__pyx_v_self->distance_set);
  __Pyx_INCREF(__pyx_t_1);
  __pyx_t_4 = PyObject_Length(__pyx_t_1); if (unlikely(__pyx_t_4 == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 26; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_v_out_ac_size = (__pyx_v_self->unique_colors * __pyx_t_4);

  /* "imfeat/_autocorrelogram/autocorrelogram.pyx":27
 *         cdef np.ndarray image = image_in
 *         cdef int out_ac_size = self.unique_colors * len(self.distance_set)
 *         cdef np.ndarray out = np.zeros(out_ac_size)             # <<<<<<<<<<<<<<
 *         cdef int height = image_in.shape[0], width = image_in.shape[1]
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = PyInt_FromLong(__pyx_v_out_ac_size); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 27; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  ...
  /* "imfeat/_autocorrelogram/autocorrelogram.pyx":28
 *         cdef int out_ac_size = self.unique_colors * len(self.distance_set)
 *         cdef np.ndarray out = np.zeros(out_ac_size)
 *         cdef int height = image_in.shape[0], width = image_in.shape[1]             # <<<<<<<<<<<<<<
 *         cdef np.ndarray image_packed = np.zeros(height * width, dtype=np.uint8)
 ...
 */
  __pyx_t_1 = PyObject_GetAttr(__pyx_v_image_in, __pyx_n_s__shape); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 28; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_5 = __Pyx_PyInt_AsInt(__pyx_t_2); if (unlikely((__pyx_t_5 == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 28; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_v_height = __pyx_t_5;
  __pyx_t_2 = PyObject_GetAttr(__pyx_v_image_in, __pyx_n_s__shape); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 28; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_5 = __Pyx_PyInt_AsInt(__pyx_t_1); if (unlikely((__pyx_t_5 == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 28; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_v_width = __pyx_t_5;

  /* "imfeat/_autocorrelogram/autocorrelogram.pyx":29
 *         cdef np.ndarray out = np.zeros(out_ac_size)
 *         cdef int height = image_in.shape[0], width = image_in.shape[1]
 *         cdef np.ndarray image_packed = np.zeros(height * width, dtype=np.uint8)             # <<<<<<<<<<<<<<
 *         if self.unique_colors == 64:
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = PyObject_GetAttr(__pyx_t_1, __pyx_n_s__zeros); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 29; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = PyInt_FromLong((__pyx_v_height * __pyx_v_width)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 29; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __pyx_t_7 = PyObject_GetAttr(__pyx_t_6, __pyx_n_s__uint8); if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 29; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_7);
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  if (PyDict_SetItem(__pyx_t_1, ((PyObject *)__pyx_n_s__dtype), __pyx_t_7) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 29; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
  __pyx_t_7 = PyEval_CallObjectWithKeywords(__pyx_t_2, ((PyObject *)__pyx_t_3), ((PyObject *)__pyx_t_1)); if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 29; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_7);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  ...
  __pyx_v_image_packed = ((PyArrayObject *)__pyx_t_7);
  __pyx_t_7 = 0;

  /* "imfeat/_autocorrelogram/autocorrelogram.pyx":32
 *         if self.unique_colors == 64:
 *             convert_colors_rg64(<np.uint8_t *>image.data, height * width, <np.uint8_t *>image_packed.data)
 ...
 */
  switch (__pyx_v_self->unique_colors) {
    ...
    /* "imfeat/_autocorrelogram/autocorrelogram.pyx":30
 *         cdef int height = image_in.shape[0], width = image_in.shape[1]
 *         cdef np.ndarray image_packed = np.zeros(height * width, dtype=np.uint8)
 *         if self.unique_colors == 64:             # <<<<<<<<<<<<<<
 *             convert_colors_rg64(<np.uint8_t *>image.data, height * width, <np.uint8_t *>image_packed.data)
 ...
 */
    ...
    /* "imfeat/_autocorrelogram/autocorrelogram.pyx":31
 *         cdef np.ndarray image_packed = np.zeros(height * width, dtype=np.uint8)
 *         if self.unique_colors == 64:
 *             convert_colors_rg64(<np.uint8_t *>image.data, height * width, <np.uint8_t *>image_packed.data)             # <<<<<<<<<<<<<<
 *         elif self.unique_colors == 16:
 *             convert_colors_rg16(<np.uint8_t *>image.data, height * width, <np.uint8_t *>image_packed.data)
 */
    convert_colors_rg64(((__pyx_t_5numpy_uint8_t *)__pyx_v_image->data), (__pyx_v_height * __pyx_v_width), ((__pyx_t_5numpy_uint8_t *)__pyx_v_image_packed->data));
    break;
 ...
 */
    ...
    /* "imfeat/_autocorrelogram/autocorrelogram.pyx":33
 *             convert_colors_rg64(<np.uint8_t *>image.data, height * width, <np.uint8_t *>image_packed.data)
 *         elif self.unique_colors == 16:
 *             convert_colors_rg16(<np.uint8_t *>image.data, height * width, <np.uint8_t *>image_packed.data)             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
    convert_colors_rg16(((__pyx_t_5numpy_uint8_t *)__pyx_v_image->data), (__pyx_v_height * __pyx_v_width), ((__pyx_t_5numpy_uint8_t *)__pyx_v_image_packed->data));
    break;
    default:

    /* "imfeat/_autocorrelogram/autocorrelogram.pyx":35
 *             convert_colors_rg16(<np.uint8_t *>image.data, height * width, <np.uint8_t *>image_packed.data)
 *         else:
 *             raise ValueError('Invalid unique_colors value!')             # <<<<<<<<<<<<<<
 ...
 */
    __pyx_t_7 = PyObject_Call(__pyx_builtin_ValueError, ((PyObject *)__pyx_k_tuple_4), NULL); if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 35; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_7);
  ...
  /* "imfeat/_autocorrelogram/autocorrelogram.pyx":36
 *         else:
 *             raise ValueError('Invalid unique_colors value!')
 *         autocorrelogram(<np.uint8_t *>image_packed.data, height, width, self.unique_colors,             # <<<<<<<<<<<<<<
 *                         <int *>self.distance_set.data, self.distance_set.size, <np.float64_t *>out.data, out_ac_size)
 ...
 */
  __pyx_t_8 = ((__pyx_t_5numpy_uint8_t *)__pyx_v_image_packed->data);
  __pyx_t_5 = __pyx_v_self->unique_colors;

  /* "imfeat/_autocorrelogram/autocorrelogram.pyx":37
 *             raise ValueError('Invalid unique_colors value!')
 *         autocorrelogram(<np.uint8_t *>image_packed.data, height, width, self.unique_colors,
 *                         <int *>self.distance_set.data, self.distance_set.size, <np.float64_t *>out.data, out_ac_size)             # <<<<<<<<<<<<<<
 *         return [np.nan_to_num(out)]
 */
  __pyx_t_9 = ((int *)__pyx_v_self->distance_set->data);
  __pyx_t_7 = PyObject_GetAttr(((PyObject *)__pyx_v_self->distance_set), __pyx_n_s__size); if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 37; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_7);
  __pyx_t_10 = __Pyx_PyInt_AsInt(__pyx_t_7); if (unlikely((__pyx_t_10 == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 37; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
  __pyx_t_11 = ((__pyx_t_5numpy_float64_t *)__pyx_v_out->data);
  autocorrelogram(__pyx_t_8, __pyx_v_height, __pyx_v_width, __pyx_t_5, __pyx_t_9, __pyx_t_10, __pyx_t_11, __pyx_v_out_ac_size);

  /* "imfeat/_autocorrelogram/autocorrelogram.pyx":38
 *         autocorrelogram(<np.uint8_t *>image_packed.data, height, width, self.unique_colors,
 *                         <int *>self.distance_set.data, self.distance_set.size, <np.float64_t *>out.data, out_ac_size)
 *         return [np.nan_to_num(out)]             # <<<<<<<<<<<<<<
 */
  ...
  __Pyx_GOTREF(__pyx_t_7);
  __pyx_t_1 = PyObject_GetAttr(__pyx_t_7, __pyx_n_s__nan_to_num); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 38; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
  ...
  __pyx_t_3 = PyObject_Call(__pyx_t_1, ((PyObject *)__pyx_t_7), NULL); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 38; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
...
static PyObject *__pyx_pf_23_imfeat_autocorrelogram_15Autocorrelogram_1make_features(PyObject *__pyx_v_self, PyObject *__pyx_v_image_in); /*proto*/
static PyObject *__pyx_pf_23_imfeat_autocorrelogram_15Autocorrelogram_1make_features(PyObject *__pyx_v_self, PyObject *__pyx_v_image_in) {
  PyObject *__pyx_r = NULL;
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
  __Pyx_RefNannySetupContext("make_features");
  ...
  __Pyx_INCREF(__pyx_t_1);
  __pyx_t_2 = ((struct __pyx_vtabstruct_23_imfeat_autocorrelogram_Autocorrelogram *)((struct __pyx_obj_23_imfeat_autocorrelogram_Autocorrelogram *)__pyx_v_self)->__pyx_vtab)->make_features(((struct __pyx_obj_23_imfeat_autocorrelogram_Autocorrelogram *)__pyx_v_self), __pyx_t_1, 1); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 24; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_r = __pyx_t_2;
  __pyx_t_2 = 0;
...
/* "imfeat/_autocorrelogram/autocorrelogram.pyx":13
 * 
 * cdef class Autocorrelogram(imfeat.BaseFeature):
 *     cdef public object MODES             # <<<<<<<<<<<<<<
 *     cdef np.ndarray distance_set
...
static int __pyx_pf_23_imfeat_autocorrelogram_15Autocorrelogram_5MODES_1__set__(PyObject *__pyx_v_self, PyObject *__pyx_v_value); /*proto*/
static int __pyx_pf_23_imfeat_autocorrelogram_15Autocorrelogram_5MODES_1__set__(PyObject *__pyx_v_self, PyObject *__pyx_v_value) {
  int __pyx_r;
...
static int __pyx_pf_23_imfeat_autocorrelogram_15Autocorrelogram_5MODES_2__del__(PyObject *__pyx_v_self); /*proto*/
static int __pyx_pf_23_imfeat_autocorrelogram_15Autocorrelogram_5MODES_2__del__(PyObject *__pyx_v_self) {
  int __pyx_r;
...
static int __pyx_setprop_23_imfeat_autocorrelogram_15Autocorrelogram_MODES(PyObject *o, PyObject *v, void *x) {
  if (v) {
    return __pyx_pf_23_imfeat_autocorrelogram_15Autocorrelogram_5MODES_1__set__(o, v);
  }
  else {
    return __pyx_pf_23_imfeat_autocorrelogram_15Autocorrelogram_5MODES_2__del__(o);
  }
}

static PyMethodDef __pyx_methods_23_imfeat_autocorrelogram_Autocorrelogram[] = {
  {__Pyx_NAMESTR("make_features"), (PyCFunction)__pyx_pf_23_imfeat_autocorrelogram_15Autocorrelogram_1make_features, METH_O, __Pyx_DOCSTR(0)},
  {0, 0, 0, 0}
};
...
static PyTypeObject __pyx_type_23_imfeat_autocorrelogram_Autocorrelogram = {
 ...
 */
  ...
  PyTuple_SET_ITEM(__pyx_k_tuple_1, 2, __pyx_int_5);
  __Pyx_GIVEREF(__pyx_int_5);
  __Pyx_INCREF(__pyx_int_7);
  PyTuple_SET_ITEM(__pyx_k_tuple_1, 3, __pyx_int_7);
  __Pyx_GIVEREF(__pyx_int_7);
  __Pyx_GIVEREF(((PyObject *)__pyx_k_tuple_1));
  __pyx_k_tuple_2 = PyTuple_New(4); if (unlikely(!__pyx_k_tuple_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 17; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  __Pyx_GIVEREF(__pyx_int_5);
  __Pyx_INCREF(__pyx_int_7);
  PyTuple_SET_ITEM(__pyx_k_tuple_2, 3, __pyx_int_7);
  __Pyx_GIVEREF(__pyx_int_7);
...
#endif
{
  ...
  /* "imfeat/_autocorrelogram/autocorrelogram.pyx":1
 * import cv             # <<<<<<<<<<<<<<
 * import numpy as np
 * cimport numpy as np
 */
  ...
  /* "imfeat/_autocorrelogram/autocorrelogram.pyx":2
 * import cv
 * import numpy as np             # <<<<<<<<<<<<<<
 * cimport numpy as np
 * cimport imfeat
